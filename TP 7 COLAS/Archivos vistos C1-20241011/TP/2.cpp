...
2) Modifique la definición de la estructura y operaciones del TDA cola del ítem b) de modo que el almacenamiento y
recuperación de datos se realice recorriendo el arreglo forma inversa. Considere que la función siguiente se renombra
como anterior.
*/
